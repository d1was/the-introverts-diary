...
module.exports = {
  siteName: 'the boy in the yellow jacket',
  siteDescription: "A Personal blog where i want to write everything i want write.",
  siteUrl: 'https://diwaskhatri.com.np',
  titleTemplate: `%s | diwaskhatri`,
